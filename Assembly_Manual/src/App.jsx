...
export default function App() {
    ...
    const modelIn = useGLTF('./OLSK_Large_Laser_V2_All_In.glb') //Substitute the file name here for ALL IN
    const modelOut = useGLTF('./OLSK_Large_Laser_V2_All_Out.glb') //Substitute the file name here for ALL OUT
    ...
    useGLTF.clear('./OLSK_Large_Laser_V2_All_In.glb')  //Substitute the file name here for ALL IN
    useGLTF.clear('./OLSK_Large_Laser_V2_All_Out.glb') //Substitute the file name here for ALL OUT
...
useGLTF.preload('./OLSK_Large_Laser_V2_All_In.glb') //Substitute the file name here for ALL IN
useGLTF.preload('./OLSK_Large_Laser_V2_All_Out.glb') //Substitute the file name here for ALL OUT
